...
const Navbar = () => {
  return (
    <div className="sticky flex flex-row p-6 top-0 z-20 w-full -mt-6">
      <div className="bg-dark rounded-lg  border-t border-zinc-800">
        <p className="text-xs px-2 py-1 text-zinc-500 text-left">Portfolio</p>
      </div>
      <div className="flex flex-grow"></div>
      <div className="flex flex-row gap-4 right-0">
        <div className="bg-dark rounded-xl  border-t border-zinc-800">
