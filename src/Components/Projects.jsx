...
const ProjectCard = ({ title, description, link, imageUrl, isVisible }) => (
  <div
    className={`flex flex-col items-center justify-center w-full laptop:w-[700px] p-2 transition duration-500 ease-in-out border-t cursor-pointer bg-[#262937] border-zinc-800 rounded-2xl laptop:p-4 laptop:pt-6 hover:bg-dark-50 ${
      isVisible ? "" : "hidden"
    }`}
  >
    <div className="w-full px-2 mb-3">
      <div className="gap-[2px]">
        <p className="text-base -tracking-[0.011em] text-left font-medium text-white leading-6 lg:text-2xl">
          {title}
        </p>
        <p className="-tracking-[0.011em] text-left text-xs text-zinc-600 font-medium leading-4 lg:text-base">
          {description}
        </p>
      </div>
    </div>
    <div className="w-full duration-500 ease-in-out h-min laptop:mt-5 rounded-xl laptop:hover:z-10 laptop:hover:mx-auto">
      <div className="w-full border border-zinc-700 rounded-xl bg-zinc-800 h-min laptop:hover:w-[900px] laptop:hover:z-10 duration-500 ease-in-out">
        <a href={link}>
          <img
            src={imageUrl}
            alt={title}
            className="border border-gray-800 rounded-xl h-[200px] laptop:h-[400px] object-cover laptop:hover:h-[550px] laptop:hover:object-fill duration-500 ease-in-out"
          />
        </a>
      </div>
    </div>
...
const Projects = () => {
  ...
  return (
    <section
      id="portfolio"
      className="mt-12 w-full bg-[#1D1F2A] h-fit flex flex-col items-center justify-center"
    >
      <div className="flex flex-col items-center justify-center mt-8 laptop:mt-12 mx-10 laptop:mx-auto laptop:w-[85%]">
        <div className="flex flex-col items-center justify-center">
          <p className="mt-2 text-2xl laptop:text-5xl font-bold text-[#FCD667]">
            Featured Works
          </p>
          <p className="mt-6 text-gray-300 laptop:leading-9 laptop:mt-8 laptop:text-xl">
            Here are some projects I've worked on as I continue my journey in
            web development.{" "}
          </p>
          <p className="mt-3 text-gray-300 laptop:leading-9 laptop:text-xl">
            Excited to share and learn together!
          </p>
        </div>
        <button
          onClick={togglePreview}
          className="ml-48 rounded-md mt-9 laptop:hidden bg-[#FCD667] text-[#1D1F2A] font-bold laptop:font-extrabold py-1 laptop:py-4 tracking-wide text-xs laptop:text-md w-[120px] laptop:w-[200px] ease-in-out duration-300"
        >
          HIDE PREVIEW
        </button>
        <div className="flex flex-row flex-wrap justify-center w-full gap-4 mt-4 mb-8 h-min">
          <ProjectCard
            title="StreamFlix"
            description="Movie Trailer Streaming Site"
            link="https://streamflix2023.netlify.app/"
            imageUrl="/Images/StreamFlix2.png"
            isVisible={viewStreamFlix}
          />
          <ProjectCard
            title="KumoriArt"
            description="Dive into a collection of exquisite wallpapers to elevate your digital space instantly."
            link="https://kumori-art.netlify.app/"
            imageUrl="/Images/kumori-art.png"
            isVisible={viewKumoriArt}
          />
          <ProjectCard
            title="Datepicker Component"
            description="Created a Datepicker Component from Scratch"
          ...
          <ProjectCard
            title="Coming Soon.."
            description="Developing, standby"
            link="#addNew"
            imageUrl="/Images/plus.png"
            isVisible={viewComingSoon}
          />
        </div>
      </div>
      <div className="flex-col hidden laptop:flex social-icons">
        <div className="flex justify-center gap-8 mt-12 mb-12">
          <a
            href="https://www.linkedin.com/in/john-michael-dimayuga-72482415a/a"
            className=""
          >
            <svg
              ...
              height="40"
              viewBox="0,0,256,256"
              className="hover:h-[50px] ease-in-out duration-300"
            >
              <g
                fill="#ffffff"
                fill-rule="nonzero"
          ...
          <a href="#facebook">
            ...
            >
              ...
              >
                <g transform="scale(5.33333,5.33333)">
                  <path d="M11.5,6c-3.01977,0 -5.5,2.48023 -5.5,5.5v25c0,3.01977 2.48023,5.5 5.5,5.5h25c3.01977,0 5.5,-2.48023 5.5,-5.5v-25c0,-3.01977 -2.48023,-5.5 -5.5,-5.5zM11.5,9h25c1.39823,0 2.5,1.10177 2.5,2.5v25c0,1.39823 -1.10177,2.5 -2.5,2.5h-6.5v-10h3.625c0.504,0 0.93019,-0.37695 0.99219,-0.87695l0.375,-3c0.036,-0.284 -0.05414,-0.56916 -0.24414,-0.78516c-0.189,-0.215 -0.46105,-0.33789 -0.74805,-0.33789h-4v-3.5c0,-1.103 0.897,-2 2,-2h2c0.552,0 1,-0.447 1,-1v-3.375c0,-0.518 -0.39516,-0.95009 -0.91016,-0.99609c-0.059,-0.005 -1.46986,-0.12891 -3.25586,-0.12891c-4.407,0 -6.83398,2.61619 -6.83398,7.36719v3.63281h-4c-0.552,0 -1,0.447 -1,1v3c0,0.553 0.448,1 1,1h4v10h-12.5c-1.39823,0 -2.5,-1.10177 -2.5,-2.5v-25c0,-1.39823 1.10177,-2.5 2.5,-2.5z"></path>
                </g>
              </g>
            </svg>
          </a>
