    ...
    return (
        <footer className="w-full bg-[#171A22] border-t border-gray-800 py-10 flex flex-col items-center gap-4">
            ...
            <div className="flex gap-6 mt-2">
                ...
                {/* GitHub */}
                <a href="https://github.com/joedev11" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[#FF7A5C] duration-300">
                ...
                {/* LinkedIn */}
                <a href="https://www.linkedin.com/in/john-michael-dimayuga-72482415a/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[#FF7A5C] duration-300">
                    <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
