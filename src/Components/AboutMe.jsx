        ...
        <section className="mt-12">
            <div className="w-full">
                <div className="flex flex-col mt-12 items-center justify-center">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-20 h-18 text-gray-600">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 12a.75.75 0 11-1.5 0 .75.75 0 011.5 0zM12.75 12a.75.75 0 11-1.5 0 .75.75 0 011.5 0zM18.75 12a.75.75 0 11-1.5 0 .75.75 0 011.5 0z" />
                    </svg>
                    <p className="text-gray-700 -mt-2">ABOUT ME SECTION</p>
                ...
                <div className="w-[700px] flex flex-row justify-center gap-8 mt-10">
                    <div className="border-t border-gray-800 rounded-xl">
                        <div className="w-[300px] h-full border-[10px] border-gray-900 rounded-xl my-auto">
