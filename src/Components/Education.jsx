...
const Education = () => {
    return (
        <section id="education" className="w-full mt-12 h-fit laptop:h-[1080px] mb-10 laptop:mb-0">
            <div className="flex flex-col items-center justify-center mx-auto w-[70%] mb-20">
                <div className="flex flex-col items-center justify-center laptop:mt-12 laptop:w-[50%]">
                    <p className="mt-2 text-3xl laptop:text-5xl font-bold text-[#FF7A5C]">Resume</p>
                    ...
                    <div className="flex flex-col gap-8 pt-3 laptop:flex-row">
                        <div className="flex flex-col gap-2 laptop:gap-6 laptop:w-[50%]">
                            ...
                            <div className="flex flex-row gap-4 p-6 laptop:mt-4 border-t bg-[#262937] border-zinc-800 flex-start rounded-xl">
                                ...
                                <div className="flex flex-col gap-2">
                                    <p className="text-base font-semibold text-[#FF7A5C]">Web Development Certification</p>
                            ...
                            <div className="flex flex-row gap-4 p-6 border-t bg-[#262937] border-zinc-800 flex-start rounded-xl">
                                ...
                                <div className="flex flex-col gap-2">
                                    <p className="text-base font-semibold text-[#FF7A5C]">BS Mechanical Engineering - PRC Board Passer</p>
                                    <div className="flex flex-col gap-1">
                            ...
                            <div className="flex flex-row gap-4 p-6 border-t bg-[#262937] border-zinc-800 flex-start rounded-xl">
                                ...
                                <div className="flex flex-col gap-2">
                                    <p className="text-base font-semibold text-[#FF7A5C]">Grade School & High School</p>
                                    <div className="flex flex-col gap-1">
                        ...
                        <div className="flex flex-col gap-2 laptop:gap-6 laptop:w-[50%]">
                            ...
                            <div className="flex flex-row gap-4 p-6 mt-4 border-t bg-[#262937] border-zinc-800 flex-start rounded-xl">
                                ...
                                <div className="flex flex-col gap-2">
                                    <p className="text-base font-semibold text-[#FF7A5C]">Software Developer</p>
                                    <div className="flex flex-col gap-1">
                            ...
                            <div className="flex flex-row gap-4 p-6 border-t bg-[#262937] border-zinc-800 flex-start rounded-xl">
                                ...
                                <div className="flex flex-col gap-2">
                                    <p className="text-base font-semibold text-[#FF7A5C]">Business Development Manager</p>
                                    <div className="flex flex-col gap-1">
                            ...
                            <div className="flex flex-row gap-4 p-6 border-t bg-[#262937] border-zinc-800 flex-start rounded-xl">
                                ...
                                <div className="flex flex-col gap-2">
                                    <p className="text-base font-semibold text-[#FF7A5C]">CapEx Procurement Supervisor & Data Analyst</p>
                                    <div className="flex flex-col gap-1">
            ...
            <div className="flex-col items-end hidden mr-24 laptop:flex social-icons">
