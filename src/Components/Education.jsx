...
const Education = () => {
    return (
        <section id="education" className="w-full mt-12">
            <div className="flex flex-col h-[1080px] items-center justify-center mx-auto w-[70%]">
                <div className="flex flex-col items-center justify-center mt-12 w-[50%]">
                    <p className="mt-2 text-5xl font-bold text-[#FCD667]">Resume</p>
                    <p className="mt-8 text-xl leading-9 text-center text-gray-300">Sharing my educational background from De La Salle University-Manila and four years of work experience as an engineer. </p>
                </div>
